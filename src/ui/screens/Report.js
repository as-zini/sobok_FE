...
const Report = () => {
    ...
    return(
      <ReportContentsBody>
        ...
        <View style={{display:'flex', flexDirection:'row', alignItems:'flex-end', gap:10}}>
          <ReportTitle>7월</ReportTitle>
          <ReportText>2024년</ReportText>
        </View>
  ...
  const ReportContents2 = () => {
    ...
    <ReportContentsBody>
      ...
      <Text style={{fontSize:26, fontWeight:600, color:colors.fontMain80, lineHeight:34}}>{"2024년 7월\n총 적설량"}</Text>
  ...
  const ReportContents4 = () => {
    ...
    <ReportContentsBody>
      <ReportIcon source={calandar_icon} style={{width:40, height:45}}/>
      <MarginVertical top={16}/>
      <Text style={{fontSize:26, fontWeight:600, color:colors.fontMain80, lineHeight:34}}>{"7월에는"}</Text>
      <MarginVertical top={12}/>
      <View style={{flexDirection:'row'}}>
  ...
  const ReportContents5 = () => {
    ...
    <ReportContentsBody>
      <ReportIcon source={calandar_icon} style={{width:40, height:45}}/>
      <MarginVertical top={16}/>
      <Text style={{fontSize:26, fontWeight:600, color:colors.fontMain80, lineHeight:34}}>{"7월의\n최종 연속 기록은"}</Text>
      <MarginVertical top={12}/>
      <View style={{flexDirection:'row'}}>
  ...
  const ReportContents6 = () => {
    ...
    <ReportContentsBody>
      <ReportIcon source={time_icon} style={{width:40, height:48}}/>
      <MarginVertical top={16}/>
      <Text style={{fontSize:26, fontWeight:600, color:colors.fontMain80, lineHeight:34}}>{"2024년 7월,"}</Text>
      <MarginVertical top={12}/>
      <View style={{flexDirection:'row'}}>
        <ReportTitle>{"어떤 적금에\n가장 많이\n쌓였을까요?"}</ReportTitle>
      </View>
      ...
      <View style={{width:'100%', justifyContent:'center', alignItems:'center'}}>
        ...
        <View style={{flexDirection:'row', width:200}}>
          <View style={{width:100, height:100}}>
            <ReportText style={{flexGrow:1}}>6월</ReportText>
            <ReportText>{"독서 적금\n+15M 24M"}</ReportText>
          </View>
  ...
  const ReportContents7 = () => {
    ...
    <ReportContentsBody>
      <ReportIcon source={time_icon} style={{width:40, height:48}}/>
      <MarginVertical top={16}/>
      <Text style={{fontSize:26, fontWeight:600, color:colors.fontMain80, lineHeight:34}}>{"7월의 지윤 님은"}</Text>
      <MarginVertical top={12}/>
      <View style={{flexDirection:'row'}}>
        <ReportTitle>{"얼마나\n성장했을까요?"}</ReportTitle>
      </View>
      ...
      <View style={{width:'100%', justifyContent:'center', alignItems:'center'}}>
        ...
        <ReportText style={{textAlign:'center'}}>{"6월보다"}</ReportText>
        <MarginVertical top={8}/>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <View style={{width:200, height:200, padding:20, marginRight:30}}>
            <Text style={{color:"#fff", fontSize:34, fontWeight:600, zIndex:2}}>6월</Text>
            <Text style={{color:"#fff", fontSize:22, fontWeight:600, zIndex:2, position:'absolute', bottom:20, right:20}}>+18H 30M</Text>
            <Image source={report_save_bg} style={{position:'absolute', top:0, left:0}}/>
          </View>
          <View style={{width:200, height:200, padding:20, marginRight:100}}>
            <Text style={{color:"#fff", fontSize:34, fontWeight:600, zIndex:2}}>7월</Text>
            <Text style={{color:"#fff", fontSize:22, fontWeight:600, zIndex:2, position:'absolute', bottom:20, right:20}}>+18H 30M</Text>
            <Image source={report_save_bg} style={{position:'absolute', top:0, left:0}}/>
          </View>
        </ScrollView>
        ...
        <MarginVertical top={13}/>
        <ReportText style={{textAlign:'center'}}>{"6월 하루 평균보다"}</ReportText>
        <MarginVertical top={8}/>
        ...
        <SnowFlakeIcon size={16} color={"indigo"}/>
        <MarginVertical top={20}/>
        <ReportText>7월</ReportText>
        <Text style={{fontWeight:600, fontSize:22, color:colors.fontMain90}}>총 24일</Text>
        <MarginVertical top={16}/>
        <Calandar/>
        <MarginVertical top={76}/>     
        <Text style={{fontSize:14, fontWeight:500, color:colors.gray77, textAlign:'center'}}>{"7월도 수고하셨어요!\n7월의 키워드를 볼까요?"}</Text> 
        <MarginVertical top={8}/>
