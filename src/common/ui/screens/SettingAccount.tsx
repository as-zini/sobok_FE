      ...
      <Body>
        ...
        {version === 0 ? (
          <>
            ...
            <InputArea>
              <Input
                placeholder={'8-16글자 이내 대소문자, 숫자, 특수문자 포함'}
          ...
          <>
            ...
            <InputArea>
              ...
              ) : (version === 2 && editValue.length > 0 && emailRegex.test(editValue)) ||
                (version !== 2 && editValue.length > 0) ? (
                <Fontisto
                  name="check"
                  size={14}
                  color={colors.fontMain}
            ...
            {version !== 3 ? (
              <></>
            ) : phoneChecked && version === 3 ? null : phoneChecked.length === 0 ? null : (
